...
use App\Filament\Resources\JournalEntries\Schemas\JournalEntryView;
...
class JournalEntryResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Journal des écritures';
    ...
    {
        return JournalEntryView::configure($schema);
    }
